...
parser.add_argument('-u', '--user', action='store', dest='cvp_user', default='cvadmin')
parser.add_argument('-p', '--password', action='store', dest='cvp_pass', default='cvadmin')
...
auth_url = "https://%s/cvpservice/login/authenticate.do" % result.cvp_host
