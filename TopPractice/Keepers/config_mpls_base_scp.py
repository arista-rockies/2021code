...
def runcmds(z):
    ...
    while x < z:
        try:
            ...
            print(hostname)
            savecfg = os.system('sshpass -p "admin" scp admin@{}:/mnt/flash/mplsbase.cfg /Users/jpatterson/Downloads/rockiesevpn/{}_mplsbase.cfg'.format(ip, hostname))
            print('config saved!')
            print('*' * 20)
            time.sleep(1)
        except:
