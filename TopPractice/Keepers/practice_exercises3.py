...
#reverse the key value in dict2.items() using {} dict conprehension
...
macadd = 'aabb.ccdd.1122'
remac1 = ''.join(macadd.split('.'))
print(remac1)
remac2 = macadd.replace('.', '')
print(remac2)
mymac1 = ':'.join(a + b for a, b in zip(remac1[::2], remac2[1::2]))
print(mymac1)
mymac2 = ':'.join(remac1[x] + remac1[x + 1] for x in range(0, len(remac1), 2))
print(mymac2)
mymac3 = ':'.join(remac1[x:x+2] for x in range(0, len(remac1), 2))
print(mymac3)

li1 = 'a1'
li2 = 'b2'
adsf = list(zip(li1, li2))
print(adsf)
print(list(zip(remac1[::2], remac1[1::2])))
